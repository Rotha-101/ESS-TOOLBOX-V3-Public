...
% MATLAB Script for SWG02 | Powerflow Check
...
fig = figure('Name', 'SWG02 | Powerflow Check', 'NumberTitle', 'off', 'Position', [100, 100, 1200, 800]);
if true
    set(fig, 'Color', 'w');
else
...
title(tlo, 'SWG02 | Powerflow Check', 'FontWeight', 'bold', 'FontSize', 12);

axs = [];

% Extract plant data
pTotal = data.pTotal.plant2;
freq = data.freq.plant2;
...
if SAVE_FIG_AND_CLOSE
    savefig(fig, 'SNTL600MWH_SPPC_02_Powerflow_Check_20260602.fig');
