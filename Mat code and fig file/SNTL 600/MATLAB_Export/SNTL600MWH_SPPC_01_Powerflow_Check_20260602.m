...
% MATLAB Script for SWG01 | Powerflow Check
...
fig = figure('Name', 'SWG01 | Powerflow Check', 'NumberTitle', 'off', 'Position', [100, 100, 1200, 800]);
if true
    set(fig, 'Color', 'w');
else
...
title(tlo, 'SWG01 | Powerflow Check', 'FontWeight', 'bold', 'FontSize', 12);

axs = [];

% Extract plant data
pTotal = data.pTotal.plant1;
freq = data.freq.plant1;
...
if SAVE_FIG_AND_CLOSE
    savefig(fig, 'SNTL600MWH_SPPC_01_Powerflow_Check_20260602.fig');
